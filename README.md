...
Description
An Arduino-based fire fighting robot that detects fire using flame sensors and automatically moves toward it. It extinguishes the fire using a water pump and servo mechanism. The robot also supports Bluetooth-based manual control.
⚙️ Features
...
Stops and sprays water
Can also be controlled manually via Bluetooth
🎮 Controls (Bluetooth)
Command
Action
F
